...
func init() {
	proto.RegisterType((*MsgCreatePost)(nil), "cosmonaut.mars.mars.MsgCreatePost")
	proto.RegisterType((*MsgCreatePostResponse)(nil), "cosmonaut.mars.mars.MsgCreatePostResponse")
	proto.RegisterType((*MsgUpdatePost)(nil), "cosmonaut.mars.mars.MsgUpdatePost")
	proto.RegisterType((*MsgUpdatePostResponse)(nil), "cosmonaut.mars.mars.MsgUpdatePostResponse")
	proto.RegisterType((*MsgDeletePost)(nil), "cosmonaut.mars.mars.MsgDeletePost")
	proto.RegisterType((*MsgDeletePostResponse)(nil), "cosmonaut.mars.mars.MsgDeletePostResponse")
}
...
var fileDescriptor_b55283ff92db0be3 = []byte{
	...
	0xcf, 0x4b, 0x2c, 0x2d, 0xd1, 0x03, 0x49, 0x80, 0x09, 0x29, 0x7e, 0xb0, 0x9a, 0x82, 0xfc, 0xe2,
	0x12, 0x88, 0x2a, 0xa5, 0x60, 0x2e, 0x5e, 0xdf, 0xe2, 0x74, 0xe7, 0xa2, 0xd4, 0xc4, 0x92, 0xd4,
	...
	,
	...
	0x6e, 0x9e, 0x3e, 0x38, 0xc5, 0x56, 0x40, 0xa8, 0x92, 0xca, 0x82, 0xd4, 0xe2, 0x24, 0x36, 0x70,
	0xd2, 0x35, 0x06, 0x04, 0x00, 0x00, 0xff, 0xff, 0x3e, 0xaa, 0x6a, 0x6c, 0xf1, 0x02, 0x00, 0x00,
}
...
func (c *msgClient) CreatePost(ctx context.Context, in *MsgCreatePost, opts ...grpc.CallOption) (*MsgCreatePostResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cosmonaut.mars.mars.Msg/CreatePost", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) UpdatePost(ctx context.Context, in *MsgUpdatePost, opts ...grpc.CallOption) (*MsgUpdatePostResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cosmonaut.mars.mars.Msg/UpdatePost", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) DeletePost(ctx context.Context, in *MsgDeletePost, opts ...grpc.CallOption) (*MsgDeletePostResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cosmonaut.mars.mars.Msg/DeletePost", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreatePost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cosmonaut.mars.mars.Msg/CreatePost",
	}
...
func _Msg_UpdatePost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cosmonaut.mars.mars.Msg/UpdatePost",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_DeletePost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cosmonaut.mars.mars.Msg/DeletePost",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
